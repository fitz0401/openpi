...
def test_fixed_step_budget():
    budget = TrainingBudget(name="fixed500", mode="fixed_steps", optimizer_steps=500)
    budget.validate()
    assert budget.resolve_steps(num_training_windows=100, batch_size=32) == 500
